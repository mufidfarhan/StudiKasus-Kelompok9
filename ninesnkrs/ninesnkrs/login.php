...
<html lang="en">
	...
	<body class="animsition">
		...
		<!-- Content page -->
		<section class="bg0 p-t-50" style="padding-bottom: 450px">
			<div class="container">
				<div class="flex-w flex-tr justify-content-center">
					<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
						<form action="../api/users/user-login.php" method="post" id="form_login">
							<h4 class="mtext-105 cl2 txt-center p-b-30">Login</h4>

							<div class="bor8 m-b-20 how-pos4-parent">
								<input class="stext-111 cl2 plh3 size-116 p-l-20 p-r-30" type="text" name="email" placeholder="Email" />
							</div>
							...
							<div class="size-212 p-t-20">
								<span class="mtext-90 cl2"> Don't have an account? </span>
								<a href="register.php" class="mtext-90 cl2"> Register Here </a>
							</div>
						</form>
					</div>
				</div>
