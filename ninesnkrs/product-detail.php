<?php
	...
	$data = http_request("http://localhost/ninesnkrs/api/product/product-details.php?id=$product_id");
	$data = json_decode($data, TRUE);

	$data_product = http_request("http://localhost/ninesnkrs/api/product/product-random.php");
