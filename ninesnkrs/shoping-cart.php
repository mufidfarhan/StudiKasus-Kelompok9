<?php
	...
	$data = http_request("http://localhost/ninesnkrs/api/users/user-details.php?email='$email'");
	...
	$checkout = http_request("http://localhost/ninesnkrs/api/customer_cart/cart-list.php?email='$email'");
...
<html lang="en">
	...
	<body class="animsition">
		...
		<!-- Shoping Cart -->
		<form action="../api/order_list/order-add.php" method="post" class="bg0 p-t-75 p-b-85">
			<div class="container">
				<div class="row">
							...
							<div class="wrap-table-shopping-cart">
								<table class="table-shopping-cart">
									<tr class="table_head">
										...
										<th class="column-5 text-center px-0">Total</th>
									</tr>

									<?php foreach ((array)$checkout as $checkout) { ?>
										<tr class="table_row">
											<td class="column-1">
												<div class="how-itemcart1">
													<img src="../product-image/<?= $checkout["image"]?>" alt="IMG" />
												</div>
											</td>
											...
											<input 
												type="text" 
												name="image"
												value="<?= $checkout['image'] ?>" 
												hidden
											>

											<td class="column-2"><?= $checkout["product_name"] ?> </a></td>

											<input 
												type="text" 
												name="product_name"
												value="<?= $checkout['product_name'] ?>" 
												hidden
											>

											<td class="column-3"><?php echo "Rp " .number_format($checkout['price'], 0, '', '.') ?></td>
											...
											<td class="column-5 text-center px-0">
												<?php 
													echo "Rp " .number_format(($checkout['price']*$checkout["quantity"]), 0, '', '.');
													$subtotal_checkout += ($checkout['price']*$checkout["quantity"]);
												?>
											</td>
						...
						<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
							...
							<div class="flex-w flex-t bor12 p-b-13">
								...
								<div class="size-209">
									<span class="mtext-110 cl2"> 
										<?php 
											echo "Rp " .number_format($subtotal_checkout, 0, '', '.')
										?> 
									</span>
								</div>
							</div>
							...
							<div class="flex-w flex-t bor12 p-t-15 p-b-30">
								...
								<div class="size-210 p-r-18 p-r-0-sm w-full-ssm">
									<p class="stext-110 cl6 p-t-2 p-b-20">
										<?php 
											echo "Rp " .number_format($shipping, 0, '', '.')
										?>
									</p>
								</div>

								<div class="size-208 w-full-ssm mt-2">
									<span class="stext-110 cl2"> Payment: </span>
								</div>

								<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-170" style="width: 65%;">
							...
							<div class="flex-w flex-t p-t-27 p-b-33">
								...
								<div class="size-209 p-t-1">
									<span class="mtext-110 cl2"> 
										<?php 
											echo "Rp " .number_format(($subtotal_checkout + $shipping), 0, '', '.')
										?>
									</span>
								</div>
							</div>
							...
							<input 
								type="text" 
								name="total_price"
								value="<?= ($subtotal_checkout + $shipping) ?>" 
								hidden
							>
							...
							<a 
								href="../api/order_list/order-delete.php?email='<?= $email ?>'" 
			...
			<div class="container">
				...
				<div class="p-t-40">
					...
					<p class="stext-107 cl6 txt-center">
						...
						NINESNKRS All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by
