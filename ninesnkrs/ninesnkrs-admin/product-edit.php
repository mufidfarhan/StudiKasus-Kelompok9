<?php
	...
	$admin = http_request("http://localhost/ninesnkrs/api/admin/admin-details.php?email='$email'");
	$admin = json_decode($admin, TRUE); 

	$productDetails = http_request("http://localhost/ninesnkrs/api/product/product-details.php?id=$product_id");
			...
			<div class="content">
				<div class="py-4 px-3 px-md-4">
					<div class="card mb-3 mb-md-4">
						<div class="card-header">
							<h3 class="font-weight-semi-bold mb-0">Edit Product</h3>
						</div>
						<div class="card-body pt-0">
							<!-- Form -->
							<div>
								<?php foreach ($productDetails as $productDetails) { ?>
								<form action="../api/product/product-edit.php?id=<?= $product_id ?>" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<select class="form-control" id="category" name="category">
											<option value="<?= $productDetails['category'] ?>" hidden><?= ucfirst($productDetails['category']) ?></option>
									...
									<div class="form-group">
										...
										<div class="mb-3 imgcontainer">
											<img src="../product-image/<?= $productDetails["image1"]?>" alt="...">
										</div>
									...
									<div class="form-group">
										...
										<div class="mb-3 imgcontainer">
											<img src="../product-image/<?= $productDetails["image2"]?>" alt="...">
										</div>
									...
									<div class="form-group">
										...
										<div class="mb-3 imgcontainer">
											<img src="../product-image/<?= $productDetails["image3"]?>" alt="...">
										</div>
				...
				<footer class="small p-3 px-md-4 mt-auto">
					<div class="row justify-content-between">
						<div class="col-lg text-center text-lg-right">&copy; 2022 NINESNKRS. All Rights Reserved.</div>
					</div>
				</footer>
				<!-- End Footer -->
			</div>
