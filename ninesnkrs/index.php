				...
				<div class="wrap-menu-desktop">
					<nav class="limiter-menu-desktop container">
						...
						<div class="wrap-icon-header flex-w flex-r-m">
							...
							<a href="account-details.php" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
						...
						<div class="container h-full">
							<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
								<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
									<span class="ltextmen new-101 cl2 respon2"> Women Collection 2022 </span>
								</div>
						...
						<div class="container h-full">
							<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
								...
								<div class="layer-slick1 animated visible-false" data-appear="lightSpeedIn" data-delay="800">
									<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">Keep Active</h2>
								</div>
						...
						<div class="container h-full">
							<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
								<div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft" data-delay="0">
									<span class="ltext-101 cl2 respon2"> Men Collection 2022 </span>
								</div>
		...
		<section class="bg0 p-t-23 p-b-140">
			<div class="container">
				...
				<div class="row isotope-grid">
					<?php $i = 0; foreach ($data as $data => $val) { ?>
						<a href="product-detail.php?id=<?= $val["id"] ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?= $val["category"] ?>">
								<!-- Block2 -->
								<div class="block2">
