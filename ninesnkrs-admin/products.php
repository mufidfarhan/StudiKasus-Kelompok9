				...
				<div class="py-4 px-3 px-md-4">
					<div class="card mb-3 mb-md-4">
						<div class="card-header">
							<h3 class="font-weight-semi-bold mb-0">Product List</h3>
						</div>
								...
								<table class="table text-nowrap mb-0">
									<thead>
										<tr>
											...
											<th class="font-weight-semi-bold border-top-0 py-2">Product</th>
												...
												<td class="align-middle py-3">
													<div class="d-flex align-items-center">
														<div class="position-relative mr-2">
															<img class="avatar mr-md-2" src="../product-image/<?= $data["image1"] ?>" alt="Image Description">
														</div>
												...
												<td class="py-3">
													<div class="position-relative m-auto">
														...
														>
															...
															<li class="unfold-item">
																<a class="unfold-link media align-items-center text-nowrap" href="product-edit.php?id=<?= $data["id"] ?>">
															...
															<li class="unfold-item">
																<a 
																	href="../api/product/product-delete.php?id=<?= $data['id'] ?>" 
